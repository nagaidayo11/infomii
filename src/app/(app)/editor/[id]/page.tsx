...
function EditorWithPageId() {
  ...
  useEffect(() => {
    ...
    Promise.all([getPage(pageId), getPageCards(pageId)]).then(async ([page, rows]) => {
      ...
      // New page: initialize with useful starter cards (Welcome, WiFi, Breakfast, Checkout, Nearby)
      if (page) {
...
/**
 * Card editor at /editor/[id]. Loads page and cards, initializes starter cards for new pages.
