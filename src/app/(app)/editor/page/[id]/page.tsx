  ...
  async function onStartStripeCheckout() {
    ...
    try {
      ...
      const url = await createStripeCheckoutSession({
        successPath: `/editor/page/${id}?billing=success`,
        cancelPath: `/editor/page/${id}?billing=cancel`,
      });
            ...
            <>
              ...
              <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_420px]">
                    ...
                    <div className="mb-3 flex items-center justify-between gap-2">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {nodeMapOwner && nodeMapOwner.id !== item.id && (
                          <button
                            type="button"
                            onClick={() => router.push(`/editor/page/${nodeMapOwner.id}`)}
                              ...
                              <div className="mb-1 flex items-center justify-between gap-1">
                                ...
                                <button
                                  ...
                                  onClick={(e) => {
                                    ...
                                    if (target) {
                                      router.push(`/editor/page/${target.id}`);
                                    }
                                  }}
                ...
                <section className="space-y-5 lg:w-full">
                        ...
                        {previewOverlay ? (
                          ...
                          >
                            ...
                            {previewOverlay.loading ? (
                              ...
                              <article
                                className="mx-auto h-[740px] max-w-sm overflow-hidden rounded-3xl border border-slate-200 p-6 shadow-sm"
                                style={{
                  ...
                  <details className="rounded-2xl border border-sky-200 bg-sky-50/70 p-4 shadow-sm">
                  ...
                  <details className="rounded-2xl border border-emerald-200 bg-emerald-50/70 p-4 shadow-sm">
                    <summary className="cursor-pointer list-none text-sm font-semibold text-emerald-900">
                      公開後チェック
                    </summary>
