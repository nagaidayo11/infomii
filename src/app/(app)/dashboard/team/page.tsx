                      ...
                      {canReviewApprovals && row.status === "pending" && (
                        <div className="flex flex-wrap gap-2">
                          <button
                            ...
                            className="min-h-[40px] rounded-lg bg-emerald-600 px-3 py-2 text-xs font-medium text-white hover:bg-emerald-700 disabled:opacity-50"
                          >
                            承認して公開
                          </button>
                          <button
                            ...
                            className="min-h-[40px] rounded-lg border border-rose-200 bg-white px-3 py-2 text-xs font-medium text-rose-700 hover:bg-rose-50 disabled:opacity-50"
                          >
                            却下
                          </button>
                        </div>
