...
export const MARKETPLACE_SEED_TEMPLATES = [
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("駅前ステイ導線", [{ label: "駅出口マップ", icon: "train" }, { label: "朝食BOX", icon: "coffee" }, { label: "自動精算機", icon: "checkout" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("長期滞在メニュー", [{ label: "清掃依頼", icon: "sparkles" }, { label: "生活用品", icon: "shopping-bag" }, { label: "延泊相談", icon: "calendar" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("深夜到着ショートカット", [{ label: "夜間入口", icon: "door-open" }, { label: "翌朝朝食", icon: "coffee" }, { label: "緊急連絡", icon: "phone" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("会議参加メニュー", [{ label: "会場アクセス", icon: "map-pin" }, { label: "領収書発行", icon: "receipt" }, { label: "資料発送", icon: "package" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("安心ステイ導線", [{ label: "貸出備品", icon: "package" }, { label: "夜間連絡", icon: "phone-call" }, { label: "非常口確認", icon: "shield" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("朝活メニュー", [{ label: "朝食開始", icon: "coffee" }, { label: "ランコース", icon: "route" }, { label: "早朝精算", icon: "credit-card" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("基本メニュー", [{ label: "Wi-Fi確認", icon: "wifi" }, { label: "朝食案内", icon: "utensils" }, { label: "周辺地図", icon: "map-pin" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("長期滞在リンク", [{ label: "清掃スケジュール", icon: "calendar" }, { label: "生活用品補充", icon: "shopping-bag" }, { label: "近隣スーパー", icon: "map-pin" }])),
...

  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("リゾート体験メニュー", [{ label: "海アクティビティ", icon: "waves" }, { label: "スパ予約", icon: "bath" }, { label: "夕景スポット", icon: "camera" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ウェルネス導線", [{ label: "スパ空き時間", icon: "bath" }, { label: "ヘルシー朝食", icon: "leaf" }, { label: "休憩ラウンジ", icon: "sofa" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("連泊体験リンク", [{ label: "1日目プラン", icon: "calendar-days" }, { label: "体験予約", icon: "waves" }, { label: "ブランチ案内", icon: "coffee" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ハネムーン導線", [{ label: "記念日ディナー", icon: "utensils" }, { label: "フォトスポット", icon: "camera" }, { label: "花束相談", icon: "flower" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("アクティビティ導線", [{ label: "SUP予約", icon: "waves" }, { label: "森ツアー", icon: "trees" }, { label: "星空集合", icon: "star" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("リゾート基本メニュー", [{ label: "館内施設", icon: "building" }, { label: "朝食会場", icon: "utensils" }, { label: "周辺散策", icon: "map-pin" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ファミリー基本リンク", [{ label: "キッズ備品", icon: "baby" }, { label: "駐車場精算", icon: "car" }, { label: "近くの公園", icon: "trees" }])),
...

  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("旅館おもてなし導線", [{ label: "大浴場作法", icon: "bath" }, { label: "夕食時間", icon: "utensils" }, { label: "館内履き", icon: "footprints" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("食事時間リンク", [{ label: "夕食会席", icon: "utensils" }, { label: "朝食和膳", icon: "rice" }, { label: "アレルギー相談", icon: "message-circle" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("団体旅行リンク", [{ label: "大広間案内", icon: "users" }, { label: "バス乗り場", icon: "bus" }, { label: "代表者精算", icon: "receipt" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("三世代滞在リンク", [{ label: "貸切風呂", icon: "bath" }, { label: "やわらか食", icon: "utensils" }, { label: "段差少なめ散策", icon: "route" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("旅館基本リンク", [{ label: "温泉時間", icon: "bath" }, { label: "食事処", icon: "utensils" }, { label: "出発準備", icon: "checkout" }])),
...

  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("セルフ滞在リンク", [{ label: "解錠手順", icon: "key" }, { label: "ゴミ分別", icon: "trash-2" }, { label: "退室報告", icon: "send" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ワーケーションリンク", [{ label: "ワーク設備", icon: "laptop" }, { label: "近隣カフェ", icon: "coffee" }, { label: "長期割ルール", icon: "calendar" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ファミリー民泊リンク", [{ label: "子ども用備品", icon: "baby" }, { label: "近くの公園", icon: "trees" }, { label: "小児科案内", icon: "heart-pulse" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("一人旅リンク", [{ label: "入室コード", icon: "key" }, { label: "近隣ごはん", icon: "utensils" }, { label: "夜間移動", icon: "taxi-front" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("ペット滞在リンク", [{ label: "ペットルール", icon: "paw-print" }, { label: "動物病院", icon: "heart-pulse" }, { label: "散歩コース", icon: "route" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Airbnb基本リンク", [{ label: "鍵の受け取り", icon: "key" }, { label: "Wi-Fi情報", icon: "wifi" }, { label: "ゴミ出し", icon: "trash-2" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("チェックインリンク", [{ label: "入口写真", icon: "image" }, { label: "鍵ボックス", icon: "key" }, { label: "到着連絡", icon: "send" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("半日コースリンク", [{ label: "午前コース", icon: "sunrise" }, { label: "午後コース", icon: "sun" }, { label: "雨天コース", icon: "umbrella" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("グルメ巡りリンク", [{ label: "海鮮ランチ", icon: "fish" }, { label: "甘味みやげ", icon: "cake-slice" }, { label: "地酒スタンド", icon: "wine" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("雨の日リンク", [{ label: "美術館展示", icon: "palette" }, { label: "屋内市場", icon: "store" }, { label: "傘レンタル", icon: "umbrella" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("観光基本リンク", [{ label: "定番スポット", icon: "map-pin" }, { label: "交通手段", icon: "train" }, { label: "観光FAQ", icon: "circle-help" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("駅アクセスリンク", [{ label: "東口出口", icon: "train" }, { label: "徒歩ルート", icon: "route" }, { label: "タクシー乗場", icon: "taxi-front" }])),
...

  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("International Guest Links", [{ label: "交通アクセス", icon: "train" }, { label: "館内ルール", icon: "info" }, { label: "緊急連絡", icon: "phone" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Airport Access Links", [{ label: "空港バス時刻", icon: "bus" }, { label: "電車乗換", icon: "train" }, { label: "Taxi Call", icon: "taxi-front" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Family Travel Links", [{ label: "Kids Area", icon: "baby" }, { label: "Family Dining", icon: "utensils" }, { label: "Hospital Info", icon: "heart-pulse" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Public Transport Links", [{ label: "駅出口案内", icon: "train" }, { label: "バス時刻", icon: "bus" }, { label: "ICカード", icon: "credit-card" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Long Stay Links", [{ label: "清掃予定", icon: "calendar" }, { label: "Laundry Room", icon: "washing-machine" }, { label: "Daily Shopping", icon: "shopping-bag" }])),
  ...
  },
  {
    ...
    cards: ordered([
      ...
      block("pageLinks", pageLinks("Inbound Basic Links", [{ label: "Wi-Fi Setup", icon: "wifi" }, { label: "Transport", icon: "train" }, { label: "Emergency Help", icon: "phone" }])),
