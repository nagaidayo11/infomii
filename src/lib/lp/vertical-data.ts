...
export const BUSINESS_LP_CONTENT: HotelLpContent = {
  ...
  sections: {
    value: {
      ...
      description:
        "上の画面のような案内ページを作ると、フロントの繰り返し説明と紙の差し替えが減ります。",
    },
    workflow: {
      kicker: "はじめかた",
      title: "3ステップで、客室に置ける案内になる",
      description:
        "専門知識は不要です。テンプレから始めて、今日聞かれやすい項目だけ整えれば公開できます。",
    },
    scenes: {
      kicker: "こんな施設で",
      title: "シティホテルから、小規模宿まで",
      description:
        "大規模システム入れ替えではなく、まず1ページのインフォメーションから始められます。",
    },
    beforeAfter: {
      kicker: "Before / After",
    ...
    finalCta: {
      ...
      description:
        "上のスマホ枠のようなホテル案内を、テンプレから始められます。クレジットカード不要。公開まで数分です。",
    },
  },
};
