...
export const starterTemplates: StarterTemplate[] = [
  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        id: "hub-icons",
        type: "iconRow",
        iconRowBackgroundColor: "#f3f4f6",
        cardRadius: "full",
        iconSize: "lg",
        textAlign: "center",
        iconItems: [
          { id: "hub-1", icon: "svg:info", label: "はじめに", link: "/p/start", backgroundColor: "#ffffff" },
          { id: "hub-2", icon: "svg:utensils", label: "朝食", link: "/p/breakfast", backgroundColor: "#ffffff" },
          { id: "hub-3", icon: "svg:ticket", label: "ハッピーアワー", link: "/p/happy-hour", backgroundColor: "#ffffff" },
          { id: "hub-4", icon: "svg:wifi", label: "Wi-Fi", link: "/p/wifi", backgroundColor: "#ffffff" },
          { id: "hub-5", icon: "svg:key", label: "客室案内", link: "/p/room-guide", backgroundColor: "#ffffff" },
          { id: "hub-6", icon: "svg:toothbrush", label: "アメニティ", link: "/p/amenity", backgroundColor: "#ffffff" },
          { id: "hub-7", icon: "svg:hanger", label: "貸出品・売店", link: "/p/rental-shop", backgroundColor: "#ffffff" },
          { id: "hub-8", icon: "svg:broom", label: "客室清掃", link: "/p/cleaning", backgroundColor: "#ffffff" },
          { id: "hub-9", icon: "svg:washing-machine", label: "コインランドリー", link: "/p/laundry", backgroundColor: "#ffffff" },
      ...
      },
      {
        id: "hub-note",
        type: "section",
        sectionTitle: "スマホの方はこちら",
        sectionBody: "各メニューをタップすると詳細ページが開きます。",
        sectionBackgroundColor: "#f8fafc",
      },
    ],
  },
  {
    ...
    title: "【リゾートホテル】トップ案内ハブ（円形アイコン15）",
    body: "リゾート滞在向けのトップメニューです。主要導線を円形アイコンでまとめています。\n\n【メニュー】\nはじめに / 朝食 / アクティビティ / Wi-Fi / 客室案内 / アメニティ / 売店 / 清掃 / ランドリー / プール / 駐車場 / 宅急便 / スパ予約 / タクシー / モーニングコール",
    blocks: [
      {
        id: "resort-hub-title",
        type: "title",
      ...
      },
      {
        ...
        textAlign: "center",
        iconItems: [
          { id: "resort-hub-1", icon: "svg:info", label: "はじめに", link: "/p/start", backgroundColor: "#ffffff" },
          { id: "resort-hub-2", icon: "svg:utensils", label: "朝食", link: "/p/breakfast", backgroundColor: "#ffffff" },
          { id: "resort-hub-3", icon: "svg:ticket", label: "アクティビティ", link: "/p/activity", backgroundColor: "#ffffff" },
          { id: "resort-hub-4", icon: "svg:wifi", label: "Wi-Fi", link: "/p/wifi", backgroundColor: "#ffffff" },
          { id: "resort-hub-5", icon: "svg:key", label: "客室案内", link: "/p/room-guide", backgroundColor: "#ffffff" },
          { id: "resort-hub-6", icon: "svg:toothbrush", label: "アメニティ", link: "/p/amenity", backgroundColor: "#ffffff" },
          { id: "resort-hub-7", icon: "svg:hanger", label: "売店", link: "/p/shop", backgroundColor: "#ffffff" },
          { id: "resort-hub-8", icon: "svg:broom", label: "清掃", link: "/p/cleaning", backgroundColor: "#ffffff" },
          { id: "resort-hub-9", icon: "svg:washing-machine", label: "ランドリー", link: "/p/laundry", backgroundColor: "#ffffff" },
          { id: "resort-hub-10", icon: "svg:bath", label: "プール/スパ", link: "/p/spa", backgroundColor: "#ffffff" },
          { id: "resort-hub-11", icon: "svg:car", label: "駐車場", link: "/p/parking", backgroundColor: "#ffffff" },
          { id: "resort-hub-12", icon: "svg:package", label: "宅急便", link: "/p/delivery", backgroundColor: "#ffffff" },
          { id: "resort-hub-13", icon: "svg:bath", label: "スパ予約", link: "/p/spa-reserve", backgroundColor: "#ffffff" },
          { id: "resort-hub-14", icon: "svg:taxi", label: "タクシー", link: "/p/taxi", backgroundColor: "#ffffff" },
          { id: "resort-hub-15", icon: "svg:phone", label: "モーニングコール", link: "/p/wakeup-call", backgroundColor: "#ffffff" },
        ],
      },
    ],
  },
  {
    industry: "ryokan",
    title: "【旅館】トップ案内ハブ（円形アイコン15）",
    body: "旅館滞在向けのトップメニューです。館内導線を円形アイコンでまとめています。\n\n【メニュー】\nはじめに / お食事 / 大浴場 / Wi-Fi / 客室案内 / アメニティ / 売店 / 清掃 / ランドリー / 館内マップ / 駐車場 / 宅急便 / 貸切風呂 / タクシー / モーニングコール",
    blocks: [
      {
        id: "ryokan-hub-title",
        type: "title",
      ...
      },
      {
        ...
        textAlign: "center",
        iconItems: [
          { id: "ryokan-hub-1", icon: "svg:info", label: "はじめに", link: "/p/start", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-2", icon: "svg:utensils", label: "お食事", link: "/p/dining", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-3", icon: "svg:bath", label: "大浴場", link: "/p/bath", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-4", icon: "svg:wifi", label: "Wi-Fi", link: "/p/wifi", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-5", icon: "svg:key", label: "客室案内", link: "/p/room-guide", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-6", icon: "svg:toothbrush", label: "アメニティ", link: "/p/amenity", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-7", icon: "svg:hanger", label: "売店", link: "/p/shop", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-8", icon: "svg:broom", label: "清掃", link: "/p/cleaning", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-9", icon: "svg:washing-machine", label: "ランドリー", link: "/p/laundry", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-10", icon: "svg:map-pin", label: "館内マップ", link: "/p/map", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-11", icon: "svg:car", label: "駐車場", link: "/p/parking", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-12", icon: "svg:package", label: "宅急便", link: "/p/delivery", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-13", icon: "svg:bath", label: "貸切風呂", link: "/p/private-bath", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-14", icon: "svg:taxi", label: "タクシー", link: "/p/taxi", backgroundColor: "#ffffff" },
          { id: "ryokan-hub-15", icon: "svg:phone", label: "モーニングコール", link: "/p/wakeup-call", backgroundColor: "#ffffff" },
        ],
      },
    ],
  },
  ...
  {
    industry: "hotel_business",
    title: "【ビジネスホテル】朝食会場・混雑時間のご案内",
    body: "朝食会場の営業時間と混雑傾向をご案内します。\n\n【営業時間】\n6:30〜9:30（最終入店 9:00）\n\n【比較的空いている時間】\n6:30〜7:15 / 8:45〜9:15\n\n【混雑しやすい時間】\n7:30〜8:30\n\n【会場】\n1F レストラン\n\n【注意事項】\n混雑時は入場をお待ちいただく場合があります",
    blocks: buildTemplateBlocks({
      title: "朝食会場・混雑時間のご案内",
      badgeText: "朝のご案内",
      lead: "混雑ピークを避けて、スムーズに朝食をご利用いただけます。",
      variant: "timeline",
      heroImageUrl: "/templates/hotel-business.svg",
      quickLinks: [
        { icon: "🍳", label: "朝食時間" },
      ...
      sections: [
        { title: "空いている時間", body: "6:30〜7:15 / 8:45〜9:15" },
        { title: "混雑しやすい時間", body: "7:30〜8:30" },
        { title: "注意事項", body: "混雑時は入場をお待ちいただく場合があります" },
      ],
      ctaLabel: "朝食の詳細を見る",
  ...
  {
    industry: "hotel_business",
    title: "【ビジネスホテル】客室設備・貸出備品案内",
    body: "客室設備と貸出備品の一覧です。\n\n【客室設備】\nWi-Fi / 冷蔵庫 / ドライヤー / 加湿空気清浄機\n\n【無料貸出】\n充電器 / アイロン / 毛布 / 枕追加\n\n【有料サービス】\nクリーニング / マッサージ手配\n\n【申込方法】\nフロント内線 [番号] へご連絡ください",
    blocks: buildTemplateBlocks({
      title: "客室設備・貸出備品案内",
      badgeText: "設備情報",
      lead: "滞在中によく使う設備・貸出品を一覧で確認できます。",
      variant: "practical",
      heroImageUrl: "/templates/hotel-business.svg",
      quickLinks: [
        { icon: "📶", label: "Wi-Fi" },
      ...
      sections: [
        ...
        { title: "無料貸出", body: "充電器 / アイロン / 毛布 / 枕追加" },
        { title: "有料サービス", body: "クリーニング / マッサージ手配" },
      ],
      ctaLabel: "フロントに申込",
      ctaUrl: "tel:+81-00-0000-0000",
    }),
  ...
  {
    industry: "hotel_resort",
    title: "【リゾートホテル】雨天時プログラム変更案内",
    body: "天候不良時のプログラム変更をご案内します。\n\n【変更対象】\n屋外ヨガ / クルーズ / ガーデンイベント\n\n【振替プログラム】\n屋内ワークショップ / キッズクラフト / 温浴優待\n\n【案内更新】\n当日7:00時点の天候で最終決定\n\n【連絡先】\nフロント内線 [番号]",
    blocks: buildTemplateBlocks({
      title: "雨天時プログラム変更案内",
      badgeText: "当日更新",
      lead: "屋外アクティビティの変更情報をリアルタイムで共有できます。",
      variant: "story",
      heroImageUrl: "/templates/hotel-resort.svg",
      quickLinks: [
        { icon: "🌧️", label: "変更対象" },
      ...
      sections: [
        ...
        { title: "振替プログラム", body: "屋内ワークショップ / キッズクラフト / 温浴優待" },
        { title: "最終決定時間", body: "当日7:00時点の天候で更新" },
      ],
      ctaLabel: "最新の実施状況を見る",
      ctaUrl: "https://example.com/weather-plan",
    }),
  },
  {
    industry: "hotel_resort",
    title: "【リゾートホテル】送迎シャトル・アクセス案内",
    body: "送迎シャトルとアクセス情報をご案内します。\n\n【無料送迎】\n駅発: 14:30 / 15:30 / 16:30\nホテル発: 9:00 / 10:00 / 11:00\n\n【乗り場】\n駅東口ロータリー [番号]\n\n【所要時間】\n約25分（交通状況で変動）\n\n【予約】\n前日21:00までにフロントへ",
    blocks: buildTemplateBlocks({
      title: "送迎シャトル・アクセス案内",
      badgeText: "来館前に確認",
      lead: "チェックイン前に必要な移動情報を1ページで確認できます。",
      variant: "timeline",
      heroImageUrl: "/templates/hotel-resort.svg",
      quickLinks: [
        { icon: "🚌", label: "送迎時刻" },
      ...
      sections: [
        { title: "乗り場", body: "駅東口ロータリー [番号]" },
        { title: "所要時間", body: "約25分（交通状況で変動）" },
        { title: "予約", body: "前日21:00までにフロントへ連絡" },
      ],
      ctaLabel: "送迎を予約する",
      ctaUrl: "https://example.com/shuttle",
    }),
  },
  {
    industry: "ryokan",
    title: "【旅館】チェックイン前後の荷物預かり案内",
    body: "荷物預かりサービスのご案内です。\n\n【チェックイン前】\n当日朝からお預かり可能\n\n【チェックアウト後】\n当日18:00までお預かり可能\n\n【お預かり場所】\nフロント横クローク\n\n【注意事項】\n貴重品・割れ物・生ものはお預かりできません",
    blocks: buildTemplateBlocks({
      title: "チェックイン前後の荷物預かり案内",
      badgeText: "到着前・出発後に便利",
      lead: "観光前後の移動をスムーズにする荷物預かり情報です。",
      variant: "compact",
      heroImageUrl: "/templates/ryokan.svg",
      quickLinks: [
        { icon: "🧳", label: "預かり時間" },
      ...
      sections: [
        { title: "お預かり場所", body: "フロント横クローク" },
        { title: "お預かり不可", body: "貴重品 / 割れ物 / 生もの" },
      ],
      ctaLabel: "荷物預かりを相談",
      ctaUrl: "tel:+81-00-0000-0000",
    }),
  ...
  {
    industry: "ryokan",
    title: "【旅館】館内ルール・夜間静粛時間のご案内",
    body: "快適にお過ごしいただくための館内ルールです。\n\n【静粛時間】\n22:00〜7:00\n\n【共用部利用】\nロビー: 24時間\n大浴場: 15:00〜24:00 / 5:00〜9:30\n\n【お願い】\n客室外での通話はロビーをご利用ください\n深夜の入浴時は足音にご配慮ください",
    blocks: buildTemplateBlocks({
      title: "館内ルール・静粛時間のご案内",
      badgeText: "ご滞在中のお願い",
      lead: "他のお客様にも配慮した快適な滞在ルールを共有します。",
      variant: "practical",
      heroImageUrl: "/templates/ryokan.svg",
      quickLinks: [
        { icon: "🌙", label: "静粛時間" },
      ...
      sections: [
        { title: "共用部利用", body: "ロビー: 24時間\n大浴場: 15:00〜24:00 / 5:00〜9:30" },
        { title: "お願い", body: "客室外の通話はロビーをご利用ください\n深夜の入浴時は足音にご配慮ください" },
      ],
      ctaLabel: "館内ルールを確認",
      ctaUrl: "https://example.com/rules",
    }),
  },
  {
    industry: "restaurant",
