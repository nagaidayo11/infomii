...
export function MobileGuestFrame({
  ...
  return (
    ...
    >
      <div
        className="relative w-[300px] shrink-0 overflow-hidden rounded-[2.35rem] border-[10px] border-stone-900 bg-stone-900 shadow-2xl"
        style={{
          boxShadow:
      ...
      >
        ...
        {/* Screen */}
        <div className="mt-10 flex max-h-[560px] min-h-[520px] flex-col overflow-hidden rounded-b-[1.5rem] bg-[#fafaf9]">
