...
import type { HotelPlanDefinition } from "@/lib/lp/hotel-data";

type LpHotelPricingCardProps = {
  plan: HotelPlanDefinition;
  freeSignupHref: string;
  hasProAnnual?: boolean;
};

export function LpHotelPricingCard({ plan, freeSignupHref, hasProAnnual }: LpHotelPricingCardProps) {
...
export function LpHotelPricingCompareLink() {
  return (
