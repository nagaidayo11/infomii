...
export function AIGenerateFromDescription({
  ...
  return (
    <div className={className}>
      <h3 className="text-sm font-semibold text-slate-800">AIで構成を最適化</h3>
      <p className="mt-1 text-xs text-slate-500">
        内容に合わせて、ブロックの種類・順番・見せ方を設計します。
      </p>
      <form onSubmit={handleSubmit} className="mt-3 space-y-3">
        ...
        <textarea
          ...
          placeholder="例: 朝食、Wi-Fi、大浴場、チェックアウトを見やすく案内したい"
          rows={3}
