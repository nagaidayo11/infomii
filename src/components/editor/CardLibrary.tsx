...
export const CARD_ICONS: Record<CardType, React.ReactNode> = {
  ...
  iconAccordion: (
    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <rect x="3" y="4" width="7" height="7" rx="1.5" strokeWidth={2} />
      <rect x="14" y="4" width="7" height="7" rx="1.5" strokeWidth={2} />
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 15h14M8 19h8" />
    </svg>
  ),
  icon_shortcuts: (
    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  editorialCover: (
    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16h10M7 13h7" />
    </svg>
  ),
  dayTimeline: (
    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  breakfast_crowd: (
    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <circle cx="8" cy="14" r="2.5" strokeWidth={2} />
      <circle cx="16" cy="14" r="2.5" strokeWidth={2} />
