...
const linkClass =
  "app-pressable flex min-h-[44px] items-center justify-between gap-2 border-b border-[var(--app-border)] px-4 py-3 text-left text-sm font-medium text-[var(--app-text)] last:border-b-0";
