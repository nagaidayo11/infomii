      ...
      <form onSubmit={handleSubmit} className="rounded-xl border border-slate-200 bg-white p-4 shadow-[0_1px_2px_rgba(0,0,0,0.04)]">
        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:items-end">
          ...
          <button
            type="submit"
            disabled={loading}
            className="app-button-native shrink-0 rounded-xl bg-slate-900 px-5 py-2.5 text-sm font-medium text-white shadow-sm transition hover:bg-slate-800 disabled:opacity-60"
          >
            {loading ? "生成中…" : "生成して編集"}
          </button>
        </div>
