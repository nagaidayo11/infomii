...
const PRODUCT_TAGLINE = "ホテル向け館内案内";

export { PRODUCT_TAGLINE };
...
export const APP_NAV_GROUPS: AppNavGroup[] = [
  { id: "main", label: "メニュー", hrefs: ["/dashboard", "/dashboard/pages", "/templates"] },
  { id: "ops", label: "運用", hrefs: ["/dashboard/team", "/dashboard/analytics", "/dashboard/qr"] },
  { id: "account", label: "アカウント", hrefs: ["/settings"] },
];
...
export function getNavItemsByGroup(): Array<{ id: string; label: string; items: AppNavItem[] }> {
  return APP_NAV_GROUPS.map((group) => ({
    id: group.id,
    label: group.label,
    items: group.hrefs
      .map((href) => APP_NAV_ITEMS.find((item) => item.href === href))
