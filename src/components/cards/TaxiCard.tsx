  ...
  return (
    <Card padding="md" className="">
      ...
      <p className="mt-1 text-xs text-slate-600">
        <InlineEditable value={companyName} onSave={(v) => updateKey("companyName", v)} editable={isSelected} onActivate={onActivate} className="text-xs text-slate-600" placeholder="会社名" />
      </p>
