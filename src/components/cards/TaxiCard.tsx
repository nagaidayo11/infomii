  ...
  return (
    <Card padding="md" className="">
      ...
      <p className="" style={getBodyFontSizeStyle()}>
        <InlineEditable value={phone} onSave={(v) => updateCard(card.id, { content: { ...c, phone: v } })} editable={isSelected} onActivate={onActivate} className="font-normal text-ds-primary" placeholder={labels.phonePlaceholder} />
      </p>
